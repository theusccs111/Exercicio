...
using Questao5.Domain.Resources.Settings;
using Questao5.Infrastructure.Sqlite;
using Questao5.Persistance;
...
namespace Questao5.Web
{
    public class Startup
    {
        ...
        {
            ConfigureSwaggerService(services, "Questao5.Web");
            ...
            services.AddDbContext<Questao5Context>(options =>
                options.UseSqlite(connectionString));

            // Configuração do DatabaseConfig e DatabaseBootstrap
            services.Configure<DatabaseConfig>(Configuration.GetSection("DatabaseConfig"));
            services.AddScoped<IDatabaseBootstrap, DatabaseBootstrap>();

            InjetandoServicos(services);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //    app.UseSwagger();
            //    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Questao5.Web v1"));
            //}
