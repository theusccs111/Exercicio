...
namespace Questao1 {
    class Program {
        ...
        private static void GetDataFromAccount(ContaBancaria conta)
        {
            Console.WriteLine(string.Concat("Conta ", conta.Numero.ToString(), ", Titular: ", conta.Titular, ", Saldo: ", conta.Saldo.ToString("C", new CultureInfo("en-US"))));
        }
    }
}
